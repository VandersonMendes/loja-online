    ...
    <div className={styles.vantagens}>
      <ul>
        <div className={`${styles.vantagensList} ${"container"}`}>
          <li>
            <img src={carteira} alt="icone carteira" />{" "}
            <span>
              PAGUE EM ATÉ 10X <br />
              SEM JUROS*
            </span>
          ...
          <li>
            <img src={localizacao} alt="icone localização" />{" "}
            <span>
              {" "}
          ...
          <li>
            <img src={desconto} alt="icone desconto" />{" "}
            <span>
              {" "}
              GANHE 20% <br /> DE DESCONTO*
            </span>
          </li>
          <li>
            <img src={frete} alt="icone frete" />{" "}
            <span>
          ...
          <li>
            {" "}
            <img src={trocar} alt="icone trocar" />{" "}
